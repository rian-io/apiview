...
const EndpointDetail: React.FC<EndpointDetailProps> = ({ endpoint }) => {
    if (!endpoint) {
        return (
            <div className="flex items-center justify-center w-full h-full min-h-[200px] bg-white dark:bg-gray-800 rounded-lg shadow">
                <span className="text-gray-400 text-lg text-center">No endpoint selected</span>
            </div>
        );
    }
    return (
